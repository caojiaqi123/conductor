...
public interface ElasticSearchConfiguration extends Configuration {
    ...
    ElasticSearchInstanceType ELASTICSEARCH_INSTANCE_TYPE_DEFAULT_VALUE =
            ElasticSearchInstanceType.MEMORY;

    String ELASTIC_SEARCH_URL_PROPERTY_NAME = "workflow.elasticsearch.url";
    String ELASTIC_SEARCH_URL_DEFAULT_VALUE = "http://localhost:9200";

    String ELASTIC_SEARCH_HEALTH_COLOR_PROPERTY_NAME =
            "workflow.elasticsearch.cluster.health.color";
    ...
    String ELASTIC_SEARCH_ARCHIVE_SEARCH_BATCH_SIZE_PROPERTY_NAME =
            "workflow.elasticsearch.archive.search.batchSize";
    ...
    String ELASTIC_SEARCH_ASYNC_DAO_WORKER_QUEUE_SIZE =
            "workflow.elasticsearch.async.dao.worker.queue.size";
    int DEFAULT_ASYNC_WORKER_QUEUE_SIZE = 100;

    String ELASTIC_SEARCH_ASYNC_DAO_MAX_POOL_SIZE =
            "workflow.elasticsearch.async.dao.max.pool.size";
    int DEFAULT_ASYNC_MAX_POOL_SIZE = 12;

    String ELASTIC_SEARCH_ASYNC_BUFFER_FLUSH_TIMEOUT_PROPERTY_NAME =
            "workflow.elasticsearch.async.buffer.flush.timeout.seconds";
    int ELASTIC_SEARCH_ASYNC_BUFFER_FLUSH_TIMEOUT_DEFAULT_VALUE = 10;

    String ELASTIC_SEARCH_INDEX_SHARD_COUNT_PROPERTY_NAME =
            "workflow.elasticsearch.index.shard.count";
    int ELASTIC_SEARCH_INDEX_SHARD_COUNT_DEFAULT_VALUE = 5;

    String ELASTIC_SEARCH_INDEX_REPLICAS_COUNT_PROPERTY_NAME =
            "workflow.elasticsearch.index.replicas.count";
    ...
    String ELASTIC_SEARCH_REST_CLIENT_CONNECTION_REQUEST_TIMEOUT_PROPERTY_NAME =
            "workflow.elasticsearch.rest.client.connectionRequestTimeout.milliseconds";
    ...
    default List<URI> getURIs() {
        ...
        // Since elasticsearch TransportClient is deprecated only REST transport is supported.
    ...
    default String getIndexName() {
        return getProperty(
                ELASTIC_SEARCH_INDEX_NAME_PROPERTY_NAME, ELASTIC_SEARCH_INDEX_NAME_DEFAULT_VALUE);
    }
    ...
    default String getClusterHealthColor() {
        return getProperty(
                ELASTIC_SEARCH_HEALTH_COLOR_PROPERTY_NAME,
                ELASTIC_SEARCH_HEALTH_COLOR_DEFAULT_VALUE);
    }
    ...
    default String getEmbeddedClusterName() {
        return getProperty(
                EMBEDDED_CLUSTER_NAME_PROPERTY_NAME, EMBEDDED_CLUSTER_NAME_DEFAULT_VALUE);
    }
    ...
    default int getArchiveSearchBatchSize() {
        return getIntProperty(
                ELASTIC_SEARCH_ARCHIVE_SEARCH_BATCH_SIZE_PROPERTY_NAME,
                ELASTIC_SEARCH_ARCHIVE_SEARCH_BATCH_SIZE_DEFAULT_VALUE);
    }

    default int getIndexBatchSize() {
        return getIntProperty(
                ELASTIC_SEARCH_INDEX_BATCH_SIZE_PROPERTY_NAME,
                ELASTIC_SEARCH_INDEX_BATCH_SIZE_DEFAULT_VALUE);
    }

    default int getAsyncWorkerQueueSize() {
        return getIntProperty(
                ELASTIC_SEARCH_ASYNC_DAO_WORKER_QUEUE_SIZE, DEFAULT_ASYNC_WORKER_QUEUE_SIZE);
    }
