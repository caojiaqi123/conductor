...
public class TestElasticSearchRestClientProvider {
    ...
    public void testGetRestClient() throws URISyntaxException {
        ...
        Mockito.when(configuration.getElasticsearchRestClientConnectionRequestTimeout())
                .thenReturn(30000);
        Mockito.when(configuration.getURIs())
                .thenReturn(Arrays.asList(new URI("https://localhost:9201")));

        ElasticSearchRestClientProvider elasticSearchRestClientProvider =
