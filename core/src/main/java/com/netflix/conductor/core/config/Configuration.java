...
public interface Configuration {
    ...
    String SYSTEM_TASK_WORKER_THREAD_COUNT_PROPERTY_NAME =
            "workflow.system.task.worker.thread.count";
    int SYSTEM_TASK_WORKER_THREAD_COUNT_DEFAULT_VALUE = 10;

    String SYSTEM_TASK_WORKER_CALLBACK_SECONDS_PROPERTY_NAME =
            "workflow.system.task.worker.callback.seconds";
    int SYSTEM_TASK_WORKER_CALLBACK_SECONDS_DEFAULT_VALUE = 30;

    String SYSTEM_TASK_WORKER_POLL_INTERVAL_PROPERTY_NAME =
            "workflow.system.task.worker.poll.interval";
    int SYSTEM_TASK_WORKER_POLL_INTERVAL_DEFAULT_VALUE = 50;

    String SYSTEM_TASK_WORKER_EXECUTION_NAMESPACE_PROPERTY_NAME =
            "workflow.system.task.worker.executionNameSpace";
    String SYSTEM_TASK_WORKER_EXECUTION_NAMESPACE_DEFAULT_VALUE = "";

    String SYSTEM_TASK_WORKER_ISOLATED_THREAD_COUNT_PROPERTY_NAME =
            "workflow.isolated.system.task.worker.thread.count";
    ...
    String ASYNC_UPDATE_SHORT_WORKFLOW_DURATION_PROPERTY_NAME =
            "async.update.short.workflow.duration.seconds";
    ...
    String EVENT_EXECUTION_INDEXING_ENABLED_PROPERTY_NAME =
            "workflow.event.execution.indexing.enabled";
    ...
    String TASK_DEF_REFRESH_TIME_SECS_PROPERTY_NAME =
            "conductor.taskdef.cache.refresh.time.seconds";
    int TASK_DEF_REFRESH_TIME_SECS_DEFAULT_VALUE = 60;

    String EVENT_HANDLER_REFRESH_TIME_SECS_PROPERTY_NAME =
            "conductor.eventhandler.cache.refresh.time.seconds";
    int EVENT_HANDLER_REFRESH_TIME_SECS_DEFAULT_VALUE = 60;

    String EVENT_EXECUTION_PERSISTENCE_TTL_SECS_PROPERTY_NAME =
            "workflow.event.execution.persistence.ttl.seconds";
    ...
    String WORKFLOW_ARCHIVAL_DELAY_QUEUE_WORKER_THREAD_COUNT_PROPERTY_NAME =
            "workflow.archival.delay.queue.worker.thread.count";
    int WORKFLOW_ARCHIVAL_DELAY_QUEUE_WORKER_THREAD_COUNT_DEFAULT_VALUE = 5;

    String SUMMARY_INPUT_OUTPUT_JSON_SERIALIZATION_ENABLED_PROPERTY_NAME =
            "summary.input.output.json.serialization.enabled";
    ...
    String ELASTIC_SEARCH_AUTO_INDEX_MANAGEMENT_ENABLED_PROPERTY_NAME =
    ...
    String ELASTIC_SEARCH_DOCUMENT_TYPE_OVERRIDE_PROPERTY_NAME =
            "workflow.elasticsearch.document.type.override";
    String ELASTIC_SEARCH_DOCUMENT_TYPE_OVERRIDE_DEFAULT_VALUE = "";

    String EVENT_QUEUE_POLL_SCHEDULER_THREAD_COUNT_PROPERTY_NAME =
    ...
    default String getLockingServerString() {
        return getProperty(LOCKING_SERVER_PROPERTY_NAME, LOCKING_SERVER_DEFAULT_VALUE)
                .toUpperCase();
    }

    default boolean ignoreLockingExceptions() {
        return getBooleanProperty(
                IGNORE_LOCKING_EXCEPTIONS_PROPERTY_NAME, IGNORE_LOCKING_EXCEPTIONS_DEFAULT_VALUE);
    }
    ...
    default boolean enableWorkflowExecutionLock() {
        return getBooleanProperty(
                EXECUTION_LOCK_ENABLED_PROPERTY_NAME, EXECUTION_LOCK_ENABLED_DEFAULT_VALUE);
    }
    ...
    default boolean isTaskExecLogIndexingEnabled() {
        return getBooleanProperty(
                TASKEXECLOG_INDEXING_ENABLED_PROPERTY_NAME,
    ...
    default int getSystemTaskWorkerThreadCount() {
        return getIntProperty(
                SYSTEM_TASK_WORKER_THREAD_COUNT_PROPERTY_NAME,
                SYSTEM_TASK_WORKER_THREAD_COUNT_DEFAULT_VALUE);
    }
    ...
    default int getSystemTaskWorkerCallbackSeconds() {
        return getIntProperty(
                SYSTEM_TASK_WORKER_CALLBACK_SECONDS_PROPERTY_NAME,
                SYSTEM_TASK_WORKER_CALLBACK_SECONDS_DEFAULT_VALUE);
    }

    /**
     * @return the interval (in seconds) at which system task queues will be polled by the system
     *     task workers
     */
    default int getSystemTaskWorkerPollInterval() {
        return getIntProperty(
                SYSTEM_TASK_WORKER_POLL_INTERVAL_PROPERTY_NAME,
                SYSTEM_TASK_WORKER_POLL_INTERVAL_DEFAULT_VALUE);
    }
    ...
    default String getSystemTaskWorkerExecutionNamespace() {
        return getProperty(
                SYSTEM_TASK_WORKER_EXECUTION_NAMESPACE_PROPERTY_NAME,
                SYSTEM_TASK_WORKER_EXECUTION_NAMESPACE_DEFAULT_VALUE);
    }

    /**
     * @return the number of threads to be used within the threadpool for system task workers in
     *     each isolation group
     */
    default int getSystemTaskWorkerIsolatedThreadCount() {
        return getIntProperty(
                SYSTEM_TASK_WORKER_ISOLATED_THREAD_COUNT_PROPERTY_NAME,
                SYSTEM_TASK_WORKER_ISOLATED_THREAD_COUNT_DEFAULT_VALUE);
    }
    ...
    default int getSystemTaskMaxPollCount() {
        return getIntProperty(
                SYSTEM_TASK_MAX_POLL_COUNT_PROPERTY_NAME, SYSTEM_TASK_MAX_POLL_COUNT_DEFAULT_VALUE);
    }

    /**
     * @return time frequency in seconds, at which the workflow sweeper should run to evaluate
     *     running workflows.
     */
    ...
    /**
     * @return when set to true, the background task workers executing async system tasks (eg HTTP)
     *     are disabled
     */
    ...
    /**
     * @return ID of the server. Can be host name, IP address or any other meaningful identifier.
     *     Used for logging
     */
    String getServerId();
    ...
    /**
     * @return name of the stack under which the app is running. e.g. devint, testintg, staging,
     *     prod etc.
     */
    String getStack();
    ...
    /**
     * @return Data center region. if hosting on Amazon the value is something like us-east-1,
     *     us-west-2 etc.
     */
    String getRegion();

    /**
     * @return Availability zone / rack. for AWS deployments, the value is something like
     *     us-east-1a, etc.
     */
    String getAvailabilityZone();

    /**
     * @return when set to true, the indexing operation to elasticsearch will be performed
     *     asynchronously
     */
    default boolean enableAsyncIndexing() {
        return getBooleanProperty(
                ASYNC_INDEXING_ENABLED_PROPERTY_NAME, ASYNC_INDEXING_ENABLED_DEFAULT_VALUE);
    }

    /**
     * @return the duration of workflow execution which qualifies a workflow as a short-running
     *     workflow for async updating to the index
     */
    default int getAsyncUpdateShortRunningWorkflowDuration() {
        return getIntProperty(
                ASYNC_UPDATE_SHORT_WORKFLOW_DURATION_PROPERTY_NAME,
                ASYNC_UPDATE_SHORT_WORKFLOW_DURATION_DEFAULT_VALUE);
    }
    ...
    default int getTaskDefRefreshTimeSecsDefaultValue() {
        return getIntProperty(
                TASK_DEF_REFRESH_TIME_SECS_PROPERTY_NAME, TASK_DEF_REFRESH_TIME_SECS_DEFAULT_VALUE);
    }
    ...
    default int getEventHandlerRefreshTimeSecsDefaultValue() {
        return getIntProperty(
                EVENT_HANDLER_REFRESH_TIME_SECS_PROPERTY_NAME,
                EVENT_HANDLER_REFRESH_TIME_SECS_DEFAULT_VALUE);
    }

    /**
     * @return The time to live in seconds of the event execution persisted. Currently, only
     *     RedisExecutionDAO supports it.
     */
    default int getEventExecutionPersistenceTTL() {
        return getIntProperty(
                EVENT_EXECUTION_PERSISTENCE_TTL_SECS_PROPERTY_NAME,
                EVENT_EXECUTION_PERSISTENCE_TTL_SECS_DEFAULT_VALUE);
    }

    default boolean isElasticSearchAutoIndexManagementEnabled() {
        return getBooleanProperty(
                ELASTIC_SEARCH_AUTO_INDEX_MANAGEMENT_ENABLED_PROPERTY_NAME,
     ...
     * Configuration#isElasticSearchAutoIndexManagementEnabled} is set to false and index management
     * is handled outside of this module.</em>
     */
    default String getElasticSearchDocumentTypeOverride() {
        return getProperty(
                ELASTIC_SEARCH_DOCUMENT_TYPE_OVERRIDE_PROPERTY_NAME,
                ELASTIC_SEARCH_DOCUMENT_TYPE_OVERRIDE_DEFAULT_VALUE);
    }

    /**
     * @return The time to live in seconds for workflow archiving module. Currently, only
     *     RedisExecutionDAO supports it.
     */
    default int getWorkflowArchivalTTL() {
        return getIntProperty(
                WORKFLOW_ARCHIVAL_TTL_SECS_PROPERTY_NAME, WORKFLOW_ARCHIVAL_TTL_SECS_DEFAULT_VALUE);
    }
    ...
    default int getWorkflowArchivalDelayQueueWorkerThreadCount() {
        return getIntProperty(
                WORKFLOW_ARCHIVAL_DELAY_QUEUE_WORKER_THREAD_COUNT_PROPERTY_NAME,
                WORKFLOW_ARCHIVAL_DELAY_QUEUE_WORKER_THREAD_COUNT_DEFAULT_VALUE);
    }
    ...
    default boolean isSummaryInputOutputJsonSerializationEnabled() {
        return getBooleanProperty(
                SUMMARY_INPUT_OUTPUT_JSON_SERIALIZATION_ENABLED_PROPERTY_NAME,
                SUMMARY_INPUT_OUTPUT_JSON_SERIALIZATION_ENABLED_DEFAULT_VALUE);
    }

    /**
     * @return the number of threads to be use in Execution Scheduler used for polling events from
     *     multiple event queues.
     *     <p>By default when not configured, null will be returned and the default computation
     *     scheduler(with threads equal to the number CPU cores) will be used.
     */
    default Integer getEventSchedulerPollThreadCount() {
        String threadCount =
                getProperty(EVENT_QUEUE_POLL_SCHEDULER_THREAD_COUNT_PROPERTY_NAME, null);
        return Strings.isNullOrEmpty(threadCount) ? null : Integer.parseInt(threadCount);
    }

    /**
     * Configuration to enable {@link com.netflix.conductor.core.execution.WorkflowRepairService},
     * that tries to keep ExecutionDAO and QueueDAO in sync, based on the task or workflow state.
     *
     * <p>This is disabled by default; To enable, the Queueing layer must implement
     * QueueDAO.containsMessage method.
     *
     * @return
     */
    default boolean isWorkflowRepairServiceEnabled() {
        return getBooleanProperty(
                WORKFLOW_REPAIR_SERVICE_ENABLED, WORKFLOW_REPAIR_SERVICE_ENABLED_DEFAULT_VALUE);
    }
    ...
    /**
     * @return Provides a list of additional modules to configure. Use this to inject additional
     *     modules that should be loaded as part of the Conductor server initialization If you are
     *     creating custom tasks (com.netflix.conductor.core.execution.tasks.WorkflowSystemTask)
     *     then initialize them as part of the custom modules.
     */
    ...
    /**
     * @return The threshold of the workflow input payload size in KB beyond which the payload will
     *     be stored in {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}
     */
    Long getWorkflowInputPayloadSizeThresholdKB();

    /**
     * @return The maximum threshold of the workflow input payload size in KB beyond which input
     *     will be rejected and the workflow will be marked as FAILED
     */
    Long getMaxWorkflowInputPayloadSizeThresholdKB();

    /**
     * @return The threshold of the workflow output payload size in KB beyond which the payload will
     *     be stored in {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}
     */
    Long getWorkflowOutputPayloadSizeThresholdKB();

    /**
     * @return The maximum threshold of the workflow output payload size in KB beyond which output
     *     will be rejected and the workflow will be marked as FAILED
     */
    Long getMaxWorkflowOutputPayloadSizeThresholdKB();

    /**
     * @return The maximum threshold of the workflow variables payload size in KB beyond which the
     *     task changes will be rejected and the task will be marked as FAILED_WITH_TERMINAL_ERROR
     */
    Long getMaxWorkflowVariablesPayloadSizeThresholdKB();

    /**
     * @return The threshold of the task input payload size in KB beyond which the payload will be
     *     stored in {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}
     */
    Long getTaskInputPayloadSizeThresholdKB();

    /**
     * @return The maximum threshold of the task input payload size in KB beyond which the task
     *     input will be rejected and the task will be marked as FAILED_WITH_TERMINAL_ERROR
     */
    Long getMaxTaskInputPayloadSizeThresholdKB();

    /**
     * @return The threshold of the task output payload size in KB beyond which the payload will be
     *     stored in {@link com.netflix.conductor.common.utils.ExternalPayloadStorage}
     */
    Long getTaskOutputPayloadSizeThresholdKB();

    /**
     * @return The maximum threshold of the task output payload size in KB beyond which the task
     *     input will be rejected and the task will be marked as FAILED_WITH_TERMINAL_ERROR
     */
