...
public class SystemPropertiesConfiguration implements Configuration {
    ...
    public boolean disableAsyncWorkers() {
        String disable =
                getProperty(
                        DISABLE_ASYNC_WORKERS_PROPERTY_NAME, DISABLE_ASYNC_WORKERS_DEFAULT_VALUE);
        return Boolean.getBoolean(disable);
    }
    ...
    public boolean isEventMessageIndexingEnabled() {
        return getBooleanProperty(
                EVENT_MESSAGE_INDEXING_ENABLED_PROPERTY_NAME,
                EVENT_MESSAGE_INDEXING_ENABLED_DEFAULT_VALUE);
    }

    @Override
    public boolean isEventExecutionIndexingEnabled() {
        return getBooleanProperty(
                EVENT_EXECUTION_INDEXING_ENABLED_PROPERTY_NAME,
                EVENT_EXECUTION_INDEXING_ENABLED_DEFAULT_VALUE);
    }
